...
questions = [
    "The transcript of the audio is: Negative: {0}, Positive: {1}, Neutral: {2}. Think step by step and tell me if you think the speaker is Normal, Mildly Depressed, Moderately Depressed, or Severely Depressed? Only output the answer.",
]
...
def process_audio_file(file_path):
    ...
    if True:
        ...
        messages.append({"role": "user", "content": f"Analyze the following audio transcript and answer the questions I ask"}) #Added.  File path in prompt.
        try:
...
csv_filename = f"{model_name}_new_prompt_no_audio_cot_analysis.csv"
