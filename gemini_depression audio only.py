...
questions = [
    ...
    "Based on the audio, what is the speaker's tone in each clip?",
        ...
        while True:
            try:
                r2 = chat.send_message(
                    ["Analyze the following audio and tell me the emotion and sentiment of the speaker. "
...
csv_filename = f"{model_name}_new_prompt_audio_only_analysis.csv"
