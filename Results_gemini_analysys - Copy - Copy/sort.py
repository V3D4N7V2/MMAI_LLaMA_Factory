...
if __name__ == "__main__":
    ...
    csv_files = [
        ...
        "gemini-2.0-flash_new_prompt_no_audio_analysis.csv",
"gemini-2.0-flash_no_audio_analysis.csv",
"gemini-2.0-flash-lite_new_prompt_no_audio_analysis.csv",
"gemini-2.0-flash-lite_no_audio_analysis.csv"
    ]
